  ...
  return (
    <div className='p-3 shadow-sm flex justify-between items-center px-4'>
      <div className='flex gap-2'>
       <div className='w-12 h-12 round-full overflow-hidden '><img src='1.png' class='w-full h-full object-cover'/>
       </div>
       <h1 className='m-1.5 font-extrabold text-2xl text-gray-500'>Ai Voyage</h1>
       </div>
